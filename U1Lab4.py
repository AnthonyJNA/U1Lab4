...
class HolidayEcuador(HolidayBase):
    """
    Una clase para representar un feriado en Ecuador por provincia (FeriadoEcuador)
    ...
    _población(self, year):
        Vuelve si una fecha es feriado o no
    """     
    # ISO 3166-2 códigos para las subdivisiones principales, 
    # llamadas provincias
    # https://es.wikipedia.org/wiki/ISO_3166-2:EC
    PROVINCIAS = ["EC-P"]  # TODO añadir más provincias
    ...
    def _populate(self, año):
        ...
        self[easter(año)] = "Día de Pascuas [Easter Day]"
        ...
        # Día de Muertos y
        nombredd = "Día de los difuntos [Day of the Dead]" 
        ...
        nombre = "Fundación de Quito [Foundation of Quito]"        
...
class PicoPlaca:
    ...
    def __init__(self, placa, fecha, hora, online=False):
        """
    ...
    def __horaProhibida(self, verificarHora):
        """
    ...
    def predicir(self):
        ...
        if self.__feriado(self.fecha, self.online):
            return True
        ...
        if not self.__horaProhibida(self.hora):
            return True

        day = self.__econtrarDia(self.fecha)  # Buscar el día de la semana a partir de la fecha
...
if __name__ == '__main__':
    ...
    pyp = PicoPlaca(args.placa, args.fecha, args.hora, args.online)
